...
def bank_system():
    ...
    while True:
        try:         
            customer_action = input('\n🏦 | Welcome to the Bank Management System.\n1️⃣  Register\n2️⃣  Login \n3️⃣  Exit\nPlease enter the number of the action you want to preform, or 3 to exit: ')
            match customer_action:
                ...
                case '3':
                    ...
                    return
                case _:
                    raise bankExp.BankOptionError('Enter a VALID operation option')
                
        except bankExp.BankOptionError as e:
            print(f'🚩 | BankOptionError: {e}')        
